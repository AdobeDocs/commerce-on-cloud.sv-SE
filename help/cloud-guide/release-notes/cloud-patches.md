...
- ![korrigeringsikon](../../assets/fix.svg) **Laga** - Korrigera för [Utcheckningen misslyckas när JS-minification och paketering är aktiverade](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-27997)), som beskrivs i *Commerce Knowledgebase (biljetter AC-15867 &amp; ACSD-68617).<!-- MCLOUD-14191 -->
