...
- ![korrigeringsikon](../../assets/fix.svg) Begränsningen uppdaterades med rätt version av `symfony/yaml`-paketet som ska användas med [PHP-konstanter](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/configure/env/configure-env-yaml#php-constants). Konstantparsning fungerar inte när en tidigare version av ett `symfony/yaml`-paket än 3.2 används. [Korrigering har skickats av Vladimir Kerkhoff](https://github.com/magento/ece-tools/pull/404).<!-- MAGECLOUD-2956 -->
...
- ![ny ikon](../../assets/new.svg) **Docker-uppdateringar**—
   ...
   - Lagt till PHP 7.2-bild - Stöd för PHP 7.2 har lagts till i Cloud Docker; [Starta Docker-konfigurationen](https://developer.adobe.com/commerce/cloud-tools/docker/configure/) har uppdaterats så att den innehåller alternativet `docker:build --php` för att ange vilken version av PHP som är kompatibel med din version av Adobe Commerce.<!-- MAGECLOUD-2799 -->
...
- ![korrigeringsikon](../../assets/fix.svg) **Kronrelaterade korrigeringar**—
   ...
   - Korrigerade ett fel i distributionsfasen som gjorde att kronijobb kunde fortsätta att köras under distributionen, vilket kan orsaka databaslås och andra kritiska problem. Nu stoppas alla cron-jobb innan distributionsfasen börjar och startas om när distributionen har slutförts.&lt;!—MAGECLOUD—2537—>
...
- ![ny ikon](../../assets/new.svg) **Konfigurerar skrivskyddade anslutningar till icke-huvudnoder** - I den här versionen finns möjligheten att konfigurera en skrivskyddad anslutning till en icke-huvudnod så att den kan ta emot skrivskyddad trafik (för [MariaDB](../environment/variables-deploy.md#mysql_use_slave_connection)).<!--MAGECLOUD-143 -->[Redis](../environment/variables-deploy.md#redis_use_slave_connection) och för <!--MAGECLOUD-143 -->
...
- **Förbättrad loggning**<!-- MAGECLOUD-1253 -MAGECLOUD-1495 -->
   ...
   - Du kan nu se installations- och uppgraderingsförloppet i realtid. Anpassa filen `install_update.log` för att visa förloppet. Till exempel:
...
- Borttagen patch; åtgärdar fel i `colinmollenhour/credis` v1.6 för att aktivera stöd för Adobe Commerce i molninfrastruktur 2.2.1. Inte tillgängligt i 2.1.<!-- MAGECLOUD-1033 -->
