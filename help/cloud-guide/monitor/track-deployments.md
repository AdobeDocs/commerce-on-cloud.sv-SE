...
Datainsamlingen Distribuerar hjälper till att analysera effekten av förändringar i driftsättningen av övergripande prestanda, som CPU, minne, svarstid med mera. Se [Spåra ändringar med NerdGraph](https://docs.newrelic.com/docs/change-tracking/change-tracking-graphql/) i _New Relic-dokumentationen_.
