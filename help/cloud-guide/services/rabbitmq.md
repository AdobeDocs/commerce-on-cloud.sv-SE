...
>
>Allmänna instruktioner för uppgradering av tjänst finns i [Ändra tjänstversion](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/configure/service/services-yaml#change-service-version).
