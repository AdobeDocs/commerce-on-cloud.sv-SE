...
>
>
>Hoppa inte över versioner när du uppgraderar [!DNL RabbitMQ] i en integreringsmiljö. Endast [sekventiella uppgraderingar](https://www.rabbitmq.com/docs/upgrade#rabbitmq-version-upgradability) stöds (t.ex. 3.8 → 3.9 → 3.10 → 3.11 → 3.12 → 3.13 → 4.0 → 4.1), och varje versionsomgång måste motsvara en faktisk, lyckad driftsättning av din molnmiljö.
>
>Allmänna instruktioner för uppgradering av tjänst finns i [Ändra tjänstversion](https://experienceleague.adobe.com/sv/docs/commerce-on-cloud/user-guide/configure/service/services-yaml#change-service-version).
